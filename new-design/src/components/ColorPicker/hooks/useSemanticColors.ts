...
import type { SemanticPalette } from "../utils/semanticColors";
import { generateSemanticPalette } from "../utils/semanticColors";

export interface SemanticPaletteHookReturn {
  semanticPalette: SemanticPalette;
  generatePalette: (newBaseColor: string) => SemanticPalette;
 ...
 * @param selectedGrayScale - The gray scale to use for neutral colors
...
export function useSemanticColors(
  ...
  const generatePalette = (newBaseColor: string): SemanticPalette => {
    return generateSemanticPalette(newBaseColor, selectedGrayScale);
  };
